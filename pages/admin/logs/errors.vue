<template>
  <section class="grid gap-4">
    <header>
      ...
      <h1 class="mt-1 text-3xl font-semibold text-stone-950">Error logs</h1>
    </header>
      ...
      <table class="min-w-full text-sm">
        ...
        <tbody>
          ...
          <tr v-else-if="!rows.length">
            <td colspan="4" class="px-3 py-6 text-center text-stone-500">No error logs for current filter.</td>
          </tr>
          <tr
            v-for="row in rows"
            :key="String(row.id)"

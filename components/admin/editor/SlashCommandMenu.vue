<template>
  <div
    v-if="open"
    class="fixed z-50 max-h-[min(70vh,28rem)] w-[min(18rem,calc(100vw-1rem))] overflow-y-auto overscroll-contain rounded-md border border-stone-200 bg-white shadow-xl"

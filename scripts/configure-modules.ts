...
if (checkOnly) {
  ...
  if (!html.includes('data-path="logs.enabled"') || !html.includes('data-path="graphView.enabled"') || !html.includes('data-path="themes.enabled"') || !html.includes('data-path="themes.bundled.hexagon"') || !html.includes('data-path="postVersioning.enabled"') || !html.includes('data-path="editor.blocks.mermaid"')) {
